...
def create_app(env=None):
    ...
    # Assicura che la cartella instance/ esista (per SQLite)
...
def _migrate_db(db):
    """
    Aggiunge colonne mancanti alle tabelle esistenti (SQLite non le aggiunge automaticamente).
    Sicuro da rieseguire ad ogni avvio — ignora se la colonna esiste già.
    """
